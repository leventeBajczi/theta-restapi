...
id1=$(curl --request POST \
  ...
  --header 'Content-Type: application/json' \
  --header 'X-API-KEY: xApiKey' \
  --data '{"input":{"inputs":[{"name":"inputfile.c","content":"'$base64task'"}]},"userId":0,"parameters":["inputfile.c","--portfolio","COMPLEX"],"benchmark":{"useScheduling":true,"resources":{"logical_cpu":2,"ram_G":1,"timeout_s":10}}}' 2>/dev/null |  jq -r ".id")
